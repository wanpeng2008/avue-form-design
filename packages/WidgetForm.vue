      ...
      <el-row :gutter="data.gutter">
        ...
        >
          <template v-for="(column, index) in data.column">
            ...
            <div
              class="widget-form-crud"
              v-else-if="column.type == 'crud'"
              :key="index"
              :class="{ active: selectWidget.prop == column.prop }"
              @click="handleSelectWidget(index)"
            >
            ...
            <div
              ...
              @click="handleSelectWidget(index)"
            >
              <el-button :key="groupIndex">aaa</el-button>
            </div>
...
import WidgetFormCrud from "./WidgetFormCrud";
